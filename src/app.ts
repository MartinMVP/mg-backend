...
import membershipJourneyRoutes from './http/routes/membershipJourney.routes';
...
import fiscalOperationRoutes from './http/routes/fiscalOperation.routes';
...
import adminOperationalWorkspaceRoutes from './http/routes/admin.operationalWorkspace.routes';
...
app.use('/', membershipJourneyRoutes);
app.use('/', paymentRoutes);
app.use('/', fiscalOperationRoutes);
...
app.use('/admin', adminOperationalWorkspaceRoutes);
